...
const Contact = () => {
  return (
    ...
    <div className="container mx-auto bg-amber-400 px-4 py-8">
...
<main className="max-w-3xl mx-auto">
    ...
    <section className="mb-6">
        ...
        <form action="#" method="POST">
            ...
            <div>
                <button type="submit"
                    className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-white bg-green-500 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                    Send Message
                </button>
            </div>
        </form>

...
const Vegetables = () => {
  ...
  return (
    <div className='py-8'>
        <h1 className='text-center text-5xl text-lime-500 font-bold py-6'>VEGETABLES</h1>
    <div className='grid lg:grid-cols-3   '>
    {
     filteredFruits.map((vegetables)=>(
      ...
      <div className="min-h-[245px]">
        <img src={vegetables.img} className="w-full rounded-lg" />
      </div>
      <div className="p-6 text-center">
        <h3 className="text-xl font-bold">{vegetables.name}</h3>
        ...
        <button type="button"
          className="mt-6 px-5 py-2.5 w-full rounded-lg text-black text-sm tracking-wider font-semibold border-none outline-none bg-lime-500 hover:bg-lime-700"onClick={()=>handleAdd(vegetables)}>Add</button>
      </div>
    </div>
     ))
    }

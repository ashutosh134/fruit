...
if (isLoading) {
  ...
  return (
    <div className='py-8'>
        <h1 className='text-center text-5xl text-transparent bg-gradient-to-b from-yellow-400 via-orange-500 to-red-600 bg-clip-text  font-bold py-6'>VEGETABLES</h1>

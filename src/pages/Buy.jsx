...
const Buy = () => {
  ...
  return (
    <div className="font-sans bg-white  py-16 px-10">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-12">
          ...
          <div className="flex flex-wrap justify-end gap-4 mt-12">
            <button type="button"
              className="px-6 py-3 text-sm font-semibold tracking-wide bg-transparent border-2 text-gray-800 rounded-md hover:bg-gray-100" onClick={handleNavigate}>Pay later</button>
            <button type="button"

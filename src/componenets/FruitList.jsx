...
const FruitList = ({fruit}) => {
  ...
  return (
    ...
    <div className="p-6 text-center">
      ...
      <button type="button"
              className="w-full flex items-center justify-center gap-3 mt-6 px-6 py-3 bg-yellow-400 text-base text-gray-800 font-semibold rounded-xl" onClick={()=>handleAdd(fruit)}>
